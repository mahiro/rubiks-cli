...
namespace rubiks {
    ...
    public:
        ...
        void set_default_min_depth(size_t _default_min_depth) {
            default_min_depth = (int) _default_min_depth;
        }

        void set_default_max_depth(size_t _default_max_depth) {
        ...
        bool has_turn_option(TurnOption _turn_option) const {
            return (get_turn_option() & _turn_option) != 0;
        }

        bool has_slice_option(SliceOption _slice_option) const {
            return (get_slice_option() & _slice_option) != 0;
        }

        bool has_io_option(IOOption _io_option) const {
            return (get_io_option() & _io_option) != 0;
        }
